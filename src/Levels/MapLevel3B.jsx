        ...
        <div className="grid lg:grid-cols-2 lg:grid-rows-2 max-md:grid-cols-1 flex-wrap">
            ...
            <div className="w-full text-left m-1 flex flex-col items-center">
                <div className="card space-y-3 w-auto center">
                    <p>Imagine standing in your home, watching the ocean rise, inch by inch, threatening to wash away everything you've built. Each year, millions of tonnes of CO₂, like the 83 million metric tonnes emitted by Los Angeles, fuel climate change and bring that future closer. If we don’t take action soon, the consequences will become a harsh reality for us all.</p>
                    <p><b><i>Los Angeles</i></b>, a sprawling city of ambition, is an unknowing aggressor, releasing this CO₂ from its cars and factories. In stark contrast, the Small Island Developing States (SIDS) are the victims, fighting for their existence as rising seas devour their homes.</p>
