    ...
    return (<div className="h-full text-white flex flex-col items-center justify-center space-y-4 p-4" style={{ margin: "auto" }}>
        ...
        <div className="cards">
          ...
          <div className="text-center card hover:-translate-y-2">
            ...
            <p>A potent greenhouse gas, is mainly emitted from agriculture, fossil fuel combustion, and industrial processes. While it occurs naturally in soils and oceans, human activities have significantly increased its emissions, contributing to climate change.</p>
          </div>
        </div>
      </div>)
